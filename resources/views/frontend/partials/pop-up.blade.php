    ...
    <div class="pop-up">
        <div class="row">
            ...
            <div class="col">
                ...
                <form method="POST" action="{{ route('send-quote') }}">
                    @csrf
                    <div class="form-group">
                        <label>Your Name:</label>
                        <input type="text" class="form-control" style="border: 2px solid #0000007a;" name="name"
                            placeholder="John Smith">
                    </div>
                    <div class="form-group">
                        <label>Your Email:</label>
                        <input type="email" class="form-control" style="border: 2px solid #0000007a;" name="email"
                            placeholder="example@mail.com">
                    </div>
                    <div class="form-group">
                        <label>Your Phone:</label>
                        <input type="tel" class="form-control" style="border: 2px solid #0000007a;" name="contact"
                            placeholder="+123456789">
                    </div>
                    <div class="form-group">
                        <label>Your Message:</label>
                        <textarea class="form-control" style="border: 2px solid #0000007a; resize: none" name="message"
                            placeholder="Your Message"></textarea>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="axil-btn btn-borderd btn-fluid btn-primary"
                            style="border: 2px solid #0000007a;" name="submit-btn">Get Free
